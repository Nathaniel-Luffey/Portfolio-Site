  ...
  const [windows, setWindows] = useState([
    {
      ...
      content: (
        <div className='contentContainer'>
          <img className='aboutMePicture' src='/images/Nathaniel-Waterfall.png' alt='Nathaniel Luffey in front of Alaskan waterfall' draggable='false'/>
    ...
    },
    {
      ...
      content: (
        <div className='contentContainer'>
          <img className='serverPicture' src='/images/Server-Corner.png' alt="Nathaniel Luffey's Server Corner" draggable='false'/>
          <div className='textContainer'>
    ...
    },
    {
      ...
      content: (
        <div className='contentContainer'>
          <img className='cloudPhotoPicture' src='/images/Cloud-App.png' alt="Nathaniel Luffey's Cloud Storage App" draggable='false'/>
          <div className='textContainer'>
